...
$misAmigos = ["Jhon", "Carlo", "Manuel"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Roberto", "Roberto"); // Reemplaza las comillas vacías con los nombres de tus amigos
